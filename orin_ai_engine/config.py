...
ACADEMIC_DATASET_DIR = BACKEND_ROOT / "data" / "academics" / "final_dataset"
AGGREGATE_DATASET_PATH = BACKEND_ROOT / "data" / "academics" / "orin_academic_dataset.json"
...
DEFAULT_COLLECTION = "orin_academic_chunks"
